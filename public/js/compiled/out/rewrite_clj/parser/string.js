...
if((c === "\n")){
var G__38900 = escape_QMARK_;
var G__38901 = rewrite_clj.parser.string.flush_into.call(null,lines,buf);
escape_QMARK_ = G__38900;
lines = G__38901;
continue;
} else {
buf.append(c);

var G__38902 = (((!(escape_QMARK_))) && ((c === "\\")));
var G__38903 = lines;
escape_QMARK_ = G__38902;
lines = G__38903;
continue;
...
//# sourceMappingURL=string.js.map?rel=1563379469396
