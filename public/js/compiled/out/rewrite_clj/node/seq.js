...
rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4387__auto__,k35827,else__4388__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k35827,else__4388__auto__);
...
return (function (ret__4407__auto__,p__35832){
var vec__35833 = p__35832;
var k__4408__auto__ = cljs.core.nth.call(null,vec__35833,(0),null);
var v__4409__auto__ = cljs.core.nth.call(null,vec__35833,(1),null);
...
rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__35826){
var self__ = this;
var G__35826__$1 = this;
return (new cljs.core.RecordIter((0),G__35826__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this35828,other35829){
var self__ = this;
var this35828__$1 = this;
return (((!((other35829 == null)))) && ((this35828__$1.constructor === other35829.constructor)) && (cljs.core._EQ_.call(null,this35828__$1.tag,other35829.tag)) && (cljs.core._EQ_.call(null,this35828__$1.wrap_fn,other35829.wrap_fn)) && (cljs.core._EQ_.call(null,this35828__$1.wrap_length,other35829.wrap_length)) && (cljs.core._EQ_.call(null,this35828__$1.seq_fn,other35829.seq_fn)) && (cljs.core._EQ_.call(null,this35828__$1.children,other35829.children)) && (cljs.core._EQ_.call(null,this35828__$1.__extmap,other35829.__extmap)));
});
...
rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4392__auto__,k__4393__auto__,G__35826){
var self__ = this;
var this__4392__auto____$1 = this;
var pred__35836 = cljs.core.keyword_identical_QMARK_;
var expr__35837 = k__4393__auto__;
if(cljs.core.truth_(pred__35836.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__35837))){
return (new rewrite_clj.node.seq.SeqNode(G__35826,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__35836.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__35837))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__35826,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__35836.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__35837))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__35826,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__35836.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__35837))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__35826,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__35836.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__35837))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__35826,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4393__auto__,G__35826),null));
}
}
}
}
...
rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4384__auto__,G__35826){
var self__ = this;
var this__4384__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__35826,self__.__extmap,self__.__hash));
});
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__35830){
var extmap__4424__auto__ = (function (){var G__35839 = cljs.core.dissoc.call(null,G__35830,new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_.call(null,G__35830)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__35839);
} else {
return G__35839;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__35830),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__35830),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__35830),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__35830),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__35830),null,cljs.core.not_empty.call(null,extmap__4424__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode.call(null,new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__35841_SHARP_){
return cljs.core.apply.call(null,cljs.core.list,p1__35841_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode.call(null,new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__35842_SHARP_){
return cljs.core.apply.call(null,cljs.core.hash_map,p1__35842_SHARP_);
}),children);
});

//# sourceMappingURL=seq.js.map?rel=1563379458188
