 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v3.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v3$garden$compression$token_fn(p__41933){
var vec__41934 = p__41933;
var tag = cljs.core.nth.call(null,vec__41934,(0),null);
var re = cljs.core.nth.call(null,vec__41934,(1),null);
return ((function (vec__41934,tag,re){
return (function (s){
...
var len__4730__auto___41939 = arguments.length;
var i__4731__auto___41940 = (0);
while(true){
if((i__4731__auto___41940 < len__4730__auto___41939)){
args__4736__auto__.push((arguments[i__4731__auto___41940]));

var G__41941 = (i__4731__auto___41940 + (1));
i__4731__auto___41940 = G__41941;
continue;
} else {
}
break;
...
return p1__41937_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
/** @this {Function} */
day8.re_frame_10x.inlined_deps.garden.v1v3v3.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq41938){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq41938));
});
...
var map__41942 = temp__5733__auto__;
...
var tag = cljs.core.get.call(null,map__41942__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__41942__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__41942__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__41946 = cljs.core.subs.call(null,s1,size);
var G__41947 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__41945 = tag;
...
//# sourceMappingURL=compression.js.map?rel=1563379475694
