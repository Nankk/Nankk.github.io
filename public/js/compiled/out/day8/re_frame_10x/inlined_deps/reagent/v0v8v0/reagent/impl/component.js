...
if((i < len)){
var k = (ks[i]);
var G__40922 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__40923 = (i + (1));
m = G__40922;
i = G__40923;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__40925 = c;
var G__40925__$1 = (((G__40925 == null))?null:G__40925.prototype);
if((G__40925__$1 == null)){
return null;
} else {
return (G__40925__$1["reagentRender"]);
}
})() == null)))));
});
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__40927 = c;
var G__40927__$1 = (((G__40927 == null))?null:G__40927.prototype);
if((G__40927__$1 == null)){
return null;
} else {
return (G__40927__$1["render"]);
}
})() == null)))));
});
...
var _STAR_current_component_STAR__orig_val__40934 = day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__40935 = c;
day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__40935;
...
}finally {day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__40934;
}});
...
return ((function (G__40936,G__40936__$1){
...
var c = this;
var G__40937_40939 = (c["cljsRatom"]);
if((G__40937_40939 == null)){
} else {
day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.ratom.dispose_BANG_.call(null,G__40937_40939);
}
...
var renders_40941 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_40942 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_40941));
if((cljs.core.count.call(null,renders_40941) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_40941))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_40942)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_40942)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__40940 = name;
switch (G__40940) {
case "":
...
var G__40944 = o;
(G__40944[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__40945 = fiber;
var G__40945__$1 = (((G__40945 == null))?null:(G__40945["type"]));
if((G__40945__$1 == null)){
return null;
} else {
return (G__40945__$1["displayName"]);
}
})();
var parent = (function (){var G__40946 = fiber;
if((G__40946 == null)){
return null;
} else {
return (G__40946["return"]);
}
})();
var path = (function (){var G__40947 = parent;
var G__40947__$1 = (((G__40947 == null))?null:day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component.fiber_component_path.call(null,G__40947));
if((G__40947__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40947__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4131__auto__ = (function (){var G__40949 = c;
if((G__40949 == null)){
return null;
} else {
return (G__40949["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__40950._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__40952 = c;
if((G__40952 == null)){
return null;
} else {
return (G__40952["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__40954 = c;
if((G__40954 == null)){
return null;
} else {
return G__40954._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__40956 = instance;
if((G__40956 == null)){
return null;
} else {
return (G__40956["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__40957 = instance;
if((G__40957 == null)){
return null;
} else {
return G__40957._currentElement;
}
}
})();
var name = (function (){var G__40958 = elem;
var G__40958__$1 = (((G__40958 == null))?null:(G__40958["type"]));
if((G__40958__$1 == null)){
return null;
} else {
return (G__40958__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__40960 = elem;
if((G__40960 == null)){
return null;
} else {
return (G__40960["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__40961._owner;
}
}
})();
var path = (function (){var G__40962 = owner;
var G__40962__$1 = (((G__40962 == null))?null:day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.component.component_path.call(null,G__40962));
if((G__40962__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40962__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__40963 = c;
var G__40963__$1 = (((G__40963 == null))?null:G__40963.constructor);
if((G__40963__$1 == null)){
return null;
} else {
return day8.re_frame_10x.inlined_deps.reagent.v0v8v0.reagent.impl.util.fun_name.call(null,G__40963__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1563379474494
