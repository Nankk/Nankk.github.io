...
var G__37085 = devtools.prefs.pref.call(null,v);
v = G__37085;
continue;
} else {
return v;
...
}catch (e37088){var _e__36097__auto__ = e37088;
return false;
}})();
...
}catch (e37092){var _e__36097__auto__ = e37092;
return false;
}})();
...
}catch (e37094){var _e__36097__auto__ = e37094;
return false;
}}
}
});
...
var vec__37096 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__37096,(0),null);
var name = cljs.core.nth.call(null,vec__37096,(1),null);
...
return cljs.core.some.call(null,(function (p1__37099_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__37099_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1563379459497
