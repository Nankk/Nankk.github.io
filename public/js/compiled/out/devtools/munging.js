...
var o36980 = temp__5733__auto__;
var temp__5733__auto____$1 = (o36980["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o36981 = temp__5733__auto____$1;
return (o36981["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__36090__auto__ = f;
return (o__36090__auto__["toString"]).call(o__36090__auto__);
} else {
return "";
}
}catch (e36982){var _ = e36982;
return "";
}});
...
try{var o__36090__auto___36984 = t;
(o__36090__auto___36984["cljs$lang$ctorPrWriter"]).call(o__36090__auto___36984,t,writer);
}catch (e36983){var __36985 = e36983;
}
...
var char_code = (function (){var o__36090__auto__ = (new String(char$));
return (o__36090__auto__["charCodeAt"]).call(o__36090__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__36090__auto__ = String;
return (o__36090__auto__["fromCharCode"]).call(o__36090__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__36986 = num_code;
switch (G__36986) {
case (1):
return (185);
...
var o__36090__auto__ = String;
return (o__36090__auto__["fromCharCode"]).call(o__36090__auto__,superscript_code);
});
/**
...
}catch (e36988){var _e__36097__auto__ = e36988;
return false;
}})())){
...
var vec__36989 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__36989,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o36992 = temp__5733__auto__;
var temp__5733__auto____$1 = (o36992["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o36993 = temp__5733__auto____$1;
return (o36993["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___37000 = arguments.length;
var i__4731__auto___37001 = (0);
while(true){
if((i__4731__auto___37001 < len__4730__auto___37000)){
args__4736__auto__.push((arguments[i__4731__auto___37001]));

var G__37002 = (i__4731__auto___37001 + (1));
i__4731__auto___37001 = G__37002;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__36996){
var vec__36997 = p__36996;
var ns_detector = cljs.core.nth.call(null,vec__36997,(0),null);
...
var G__37003 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__37004 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__37003;
remaining_tokens = G__37004;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq36994){
var G__36995 = cljs.core.first.call(null,seq36994);
var seq36994__$1 = cljs.core.next.call(null,seq36994);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36995,seq36994__$1);
});
...
var vec__37008 = cljs.core.split_with.call(null,(function (p1__37007_SHARP_){
return cljs.core.not_EQ_.call(null,p1__37007_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__37008,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__37008,(1),null);
...
var vec__37014 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__37014,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__37014,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__37017 = cljs.core.rest.call(null,remaining_tokens);
var G__37018 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__37017;
name_tokens = G__37018;
continue;
} else {
...
var vec__37021 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__37021,(0),null);
var arity = cljs.core.nth.call(null,vec__37021,(1),null);
var vec__37024 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__37024,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__37024,(1),null);
var vec__37027 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__37027,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__37027,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__37027,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__37027,(3),null);
...
var vec__37033 = result;
var munged_ns = cljs.core.nth.call(null,vec__37033,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__37033,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__37033,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__37033,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__37033,(4),null);
var arity = cljs.core.nth.call(null,vec__37033,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__37037 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__37037,(0),null);
var args = cljs.core.nth.call(null,vec__37037,(1),null);
var vec__37040 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__37040,(0),null);
var name = cljs.core.nth.call(null,vec__37040,(1),null);
...
var G__37043 = (arity + (1));
var G__37044 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__37045){
var vec__37046 = p__37045;
var arity = cljs.core.nth.call(null,vec__37046,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__37046,(1),null);
...
return cljs.core.get.call(null,arities,p1__37049_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__37050_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___37057 = arguments.length;
var i__4731__auto___37058 = (0);
while(true){
if((i__4731__auto___37058 < len__4730__auto___37057)){
args__4736__auto__.push((arguments[i__4731__auto___37058]));

var G__37059 = (i__4731__auto___37058 + (1));
i__4731__auto___37058 = G__37059;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__37053){
var vec__37054 = p__37053;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__37054,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq37051){
var G__37052 = cljs.core.first.call(null,seq37051);
var seq37051__$1 = cljs.core.next.call(null,seq37051);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37052,seq37051__$1);
});
...
var G__37060 = arg;
var G__37060__$1 = (((G__37060 instanceof cljs.core.Keyword))?G__37060.fqn:null);
switch (G__37060__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__37062__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__37062__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__37062__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__37062__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__37063 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__37063,(0),null);
var fn_name = cljs.core.nth.call(null,vec__37063,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__37063,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__37063,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__37063,(4),null);
var arity = cljs.core.nth.call(null,vec__37063,(5),null);
...
var o__36090__auto__ = f;
return (o__36090__auto__["getBasis"]).call(o__36090__auto__);
});
/**
...
}catch (e37067){var _e__36097__auto__ = e37067;
...
var G__37068 = (obj[cljs.core.first.call(null,path)]);
var G__37069 = cljs.core.rest.call(null,path);
obj = G__37068;
path = G__37069;
continue;
} else {
...
return (function (accum,p__37070){
var vec__37071 = p__37070;
var bit = cljs.core.nth.call(null,vec__37071,(0),null);
var protocol = cljs.core.nth.call(null,vec__37071,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__37074){
var vec__37075 = p__37074;
var ns = cljs.core.nth.call(null,vec__37075,(0),null);
var name = cljs.core.nth.call(null,vec__37075,(1),null);
var selector = cljs.core.nth.call(null,vec__37075,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__37080,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__37080,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__37080,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__37078_SHARP_){
return (obj[cljs.core.first.call(null,p1__37078_SHARP_)]);
});})(name,sorted_matches,vec__37080,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1563379459423
