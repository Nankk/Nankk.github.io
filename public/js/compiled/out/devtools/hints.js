...
}catch (e44372){var _e = e44372;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___44375 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___44375)){
var seen_errors_44376 = temp__5733__auto___44375;
if(cljs.core.truth_(seen_errors_44376.has(self))){
} else {
seen_errors_44376.add(self);

var temp__5735__auto___44377 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___44377)){
var sense_44378 = temp__5735__auto___44377;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_44378)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1563379478758
