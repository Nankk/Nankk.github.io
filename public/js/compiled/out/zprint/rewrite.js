...
var G__39610 = rewrite_clj.zip.next.call(null,n);
loc = G__39610;
continue;
} else {
var G__39611 = rewrite_clj.zip.next.call(null,loc);
loc = G__39611;
continue;
}
} else {
var G__39612 = rewrite_clj.zip.next.call(null,loc);
loc = G__39612;
continue;
}
}
...
return rewrite_clj.zip.replace.call(null,zloc,rewrite_clj.zip.root.call(null,zprint.rewrite.prewalk_subtree.call(null,p_QMARK_,f,(function (){var G__39613 = zloc;
var G__39613__$1 = (((G__39613 == null))?null:rewrite_clj.zip.node.call(null,G__39613));
if((G__39613__$1 == null)){
return null;
} else {
return zprint.zutil.edn_STAR_.call(null,G__39613__$1);
}
})())));
});
/**
...
var G__39614 = rewrite_clj.zip.down.call(null,nloc);
nloc = G__39614;
continue;
}
break;
...
var G__39615 = rewrite_clj.zip.right.call(null,nloc);
var G__39616 = cljs.core.conj.call(null,out,nloc);
nloc = G__39615;
out = G__39616;
continue;
} else {
...
var G__39617 = rewrite_clj.zip.right.call(null,replaced_loc);
var G__39618 = cljs.core.next.call(null,new_loc);
var G__39619 = replaced_loc;
nloc = G__39617;
new_loc = G__39618;
last_loc = G__39619;
continue;
...
var new_dep = zprint.rewrite.prewalk.call(null,zloc,(function (p1__39620_SHARP_){
return ((cljs.core._EQ_.call(null,rewrite_clj.zip.tag.call(null,p1__39620_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.call(null,rewrite_clj.zip.sexpr.call(null,p1__39620_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
}),zprint.rewrite.sort_down);
return new_dep;
});

//# sourceMappingURL=rewrite.js.map?rel=1563379472484
