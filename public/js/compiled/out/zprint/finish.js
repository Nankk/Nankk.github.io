...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__39764_SHARP_){
if(cljs.core.not_EQ_.call(null,p1__39764_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__39764_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__39765){
var vec__39766 = p__39765;
var low = cljs.core.nth.call(null,vec__39766,(0),null);
var high = cljs.core.nth.call(null,vec__39766,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__39769,s,color,element,idx){
...
var style_map = cljs.core.get.call(null,map__39770__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.call(null,map__39770__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.call(null,map__39770__$1,new cljs.core.Keyword(null,"select","select",1147833503));
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__39772){
var vec__39773 = p__39772;
var s = cljs.core.nth.call(null,vec__39773,(0),null);
var style = cljs.core.nth.call(null,vec__39773,(1),null);
var start = cljs.core.nth.call(null,vec__39773,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__39776){
var vec__39777 = p__39776;
var s = cljs.core.nth.call(null,vec__39777,(0),null);
var keyword_color = cljs.core.nth.call(null,vec__39777,(1),null);
var element = cljs.core.nth.call(null,vec__39777,(2),null);
...
var G__39780 = cljs.core.next.call(null,ssv);
var G__39781 = (this_ssv == null);
var G__39782 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__39783 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.call(null,cljs.core.conj.call(null,cljs.core.conj.call(null,out,zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.call(null,out,this_ssv)
)));
ssv = G__39780;
doing_nil_QMARK_ = G__39781;
last_elide = G__39782;
out = G__39783;
continue;
}
...
var vec__39787 = cljs.core.first.call(null,remaining_cvec);
var _ = cljs.core.nth.call(null,vec__39787,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__39787,(1),null);
var element_type = cljs.core.nth.call(null,vec__39787,(2),null);
...
var G__39790 = cljs.core.next.call(null,remaining_cvec);
var G__39791 = new_idx;
var G__39792 = cljs.core.conj.call(null,out,new_idx);
remaining_cvec = G__39790;
idx = G__39791;
out = G__39792;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__39803,cursor_vec){
var vec__39804 = p__39803;
var focus_start = cljs.core.nth.call(null,vec__39804,(0),null);
var focus_end = cljs.core.nth.call(null,vec__39804,(1),null);
var focus_vec = vec__39804;
...
var vec__39807 = cljs.core.split_at.call(null,focus_start,gcw_vec);
var front = cljs.core.nth.call(null,vec__39807,(0),null);
var back = cljs.core.nth.call(null,vec__39807,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__39810){
var vec__39811 = p__39810;
var s = cljs.core.nth.call(null,vec__39811,(0),null);
var color = cljs.core.nth.call(null,vec__39811,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__39817,existing_count){
var vec__39818 = p__39817;
var s = cljs.core.nth.call(null,vec__39818,(0),null);
var cursor = cljs.core.nth.call(null,vec__39818,(1),null);
...
return cljs.core.filterv.call(null,((function (s__$1,len,cursor__$1,vec__39818,s,cursor){
return (function (p1__39814_SHARP_){
return (!(cljs.core.empty_QMARK_.call(null,cljs.core.first.call(null,p1__39814_SHARP_))));
});})(s__$1,len,cursor__$1,vec__39818,s,cursor))
...
var vec__39825 = cljs.core.first.call(null,cvec_nl);
var n = cljs.core.nth.call(null,vec__39825,(0),null);
var where = cljs.core.nth.call(null,vec__39825,(1),null);
var cvec_element = vec__39825;
if((cvec_element == null)){
var G__39828 = cljs.core.next.call(null,cvec_nl);
var G__39829 = (idx + (1));
var G__39830 = start;
var G__39831 = out;
cvec_nl = G__39828;
...
var G__39832 = cljs.core.next.call(null,cvec_nl);
var G__39833 = (idx + (1));
var G__39834 = idx;
var G__39835 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__39832;
idx = G__39833;
start = G__39834;
out = G__39835;
...
var G__39836 = cljs.core.next.call(null,cvec_nl);
var G__39837 = (idx + (1));
var G__39838 = (idx + (1));
var G__39839 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__39836;
idx = G__39837;
start = G__39838;
out = G__39839;
...
var G__39840 = cljs.core.next.call(null,cvec_nl);
var G__39841 = (idx + (1));
var G__39842 = idx;
var G__39843 = cljs.core.apply.call(null,cljs.core.conj,cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__39840;
idx = G__39841;
start = G__39842;
out = G__39843;
...
var G__39844 = cljs.core.next.call(null,cvec_nl);
var G__39845 = (idx + (1));
var G__39846 = start;
var G__39847 = cljs.core.apply.call(null,cljs.core.conj,out,cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__39844;
idx = G__39845;
start = G__39846;
out = G__39847;
...
return cljs.core.reduce.call(null,(function (p1__39849_SHARP_,p2__39848_SHARP_){
if(zprint.finish.within_QMARK_.call(null,idx,p2__39848_SHARP_)){
return cljs.core.reduced.call(null,p1__39849_SHARP_);
} else {
return (p1__39849_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__39850,p__39851){
var vec__39852 = p__39850;
var focus_begin = cljs.core.nth.call(null,vec__39852,(0),null);
var focus_end = cljs.core.nth.call(null,vec__39852,(1),null);
var vec__39855 = p__39851;
var before = cljs.core.nth.call(null,vec__39855,(0),null);
var after = cljs.core.nth.call(null,vec__39855,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__39859,cvec,focus_vec){
var map__39860 = p__39859;
var map__39860__$1 = (((((!((map__39860 == null))))?(((((map__39860.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__39860.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39860):map__39860);
var options = map__39860__$1;
var map__39861 = cljs.core.get.call(null,map__39860__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.call(null,map__39861__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.call(null,map__39861__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.call(null,map__39861__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.call(null,((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__39860,map__39860__$1,options,map__39861,map__39861__$1,focus,lines,paths){
return (function (p1__39858_SHARP_){
return zprint.finish.surround_focus.call(null,lines_to_cvec,p1__39858_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__39860,map__39860__$1,options,map__39861,map__39861__$1,focus,lines,paths))
,path_vecs);
...
//# sourceMappingURL=finish.js.map?rel=1563379472790
