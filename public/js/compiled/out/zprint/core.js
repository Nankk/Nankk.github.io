...
var vec__40487 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper.call(null,options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__40490 = zprint.zutil.find_root_and_path_nw.call(null,coll);
var root = cljs.core.nth.call(null,vec__40490,(0),null);
var path = cljs.core.nth.call(null,vec__40490,(1),null);
...
var input = cljs.core.nth.call(null,vec__40487,(0),null);
var options__$1 = cljs.core.nth.call(null,vec__40487,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__40493){
var vec__40494 = p__40493;
var width_or_options = cljs.core.nth.call(null,vec__40494,(0),null);
var options = cljs.core.nth.call(null,vec__40494,(1),null);
...
var vec__40500 = zprint.config.perform_remove.call(null,null,null,zprint.config.get_options.call(null),rest_options);
var internal_map = cljs.core.nth.call(null,vec__40500,(0),null);
var rest_options__$1 = cljs.core.nth.call(null,vec__40500,(1),null);
var _ = cljs.core.nth.call(null,vec__40500,(2),null);
var vec__40503 = zprint.config.apply_style.call(null,null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.call(null,vec__40503,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__40503,(1),null);
var style_errors = cljs.core.nth.call(null,vec__40503,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__40508){
var vec__40509 = p__40508;
var start = cljs.core.nth.call(null,vec__40509,(0),null);
var end = cljs.core.nth.call(null,vec__40509,(1),null);
...
var i__4731__auto___40522 = (0);
while(true){
if((i__4731__auto___40522 < len__4730__auto___40521)){
args__4736__auto__.push((arguments[i__4731__auto___40522]));

var G__40523 = (i__4731__auto___40522 + (1));
i__4731__auto___40522 = G__40523;
continue;
} else {
}
break;
...
var vec__40515 = zprint.core.process_rest_options.call(null,internal_options,rest);
var special_option = cljs.core.nth.call(null,vec__40515,(0),null);
var rest_options = cljs.core.nth.call(null,vec__40515,(1),null);
...
var vec__40518 = zprint.core.zprint_STAR_.call(null,coll,special_option,actual_options);
var cvec = cljs.core.nth.call(null,vec__40518,(0),null);
var options = cljs.core.nth.call(null,vec__40518,(1),null);
...
/** @this {Function} */
zprint.core.czprint_str_internal.cljs$lang$applyTo = (function (seq40512){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40513,G__40514,seq40512__$2);
});
...
/** @this {Function} */
zprint.core.zprint_str.cljs$lang$applyTo = (function (seq40526){
...
/** @this {Function} */
zprint.core.czprint_str.cljs$lang$applyTo = (function (seq40531){
...
/** @this {Function} */
zprint.core.zprint.cljs$lang$applyTo = (function (seq40536){
...
/** @this {Function} */
zprint.core.czprint.cljs$lang$applyTo = (function (seq40541){
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__40547,form){
var vec__40548 = p__40547;
var next_options = cljs.core.nth.call(null,vec__40548,(0),null);
var _ = cljs.core.nth.call(null,vec__40548,(1),null);
var indent = cljs.core.nth.call(null,vec__40548,(2),null);
var zprint_num = cljs.core.nth.call(null,vec__40548,(3),null);
...
var vec__40551 = (cljs.core.truth_((function (){var and__4120__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4120__auto__)){
...
var new_options = cljs.core.nth.call(null,vec__40551,(0),null);
var error_str = cljs.core.nth.call(null,vec__40551,(1),null);
...
return zprint.core.process_multiple_forms.call(null,pmf_options__$1,zprint.core.czprint_str_internal,zprint_specifier,forms);
...
//# sourceMappingURL=core.js.map?rel=1563379473836
