...
return [(function (){var pred__33519 = cljs.core.instance_QMARK_;
var expr__33520 = reactive_val;
if(cljs.core.truth_(pred__33519.call(null,reagent.ratom.RAtom,expr__33520))){
return "ra";
} else {
if(cljs.core.truth_(pred__33519.call(null,reagent.ratom.RCursor,expr__33520))){
return "rc";
} else {
if(cljs.core.truth_(pred__33519.call(null,reagent.ratom.Reaction,expr__33520))){
return "rx";
} else {
if(cljs.core.truth_(pred__33519.call(null,reagent.ratom.Track,expr__33520))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1563379454569
