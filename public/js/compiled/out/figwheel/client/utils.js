...
return (new CustomEvent(event_name,(function (){var obj47754 = ({"detail":data});
return obj47754;
})()));
} else {
...
var f = (function (){var pred__47761 = cljs.core._EQ_;
var expr__47762 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__47761.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__47762))){
return ((function (pred__47761,expr__47762){
return (function (p1__47755_SHARP_){
return console.warn(p1__47755_SHARP_);
});
;})(pred__47761,expr__47762))
} else {
if(cljs.core.truth_(pred__47761.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__47762))){
return ((function (pred__47761,expr__47762){
return (function (p1__47756_SHARP_){
return console.debug(p1__47756_SHARP_);
});
;})(pred__47761,expr__47762))
} else {
if(cljs.core.truth_(pred__47761.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__47762))){
return ((function (pred__47761,expr__47762){
return (function (p1__47757_SHARP_){
return console.error(p1__47757_SHARP_);
});
;})(pred__47761,expr__47762))
} else {
return ((function (pred__47761,expr__47762){
return (function (p1__47758_SHARP_){
return console.log(p1__47758_SHARP_);
});
;})(pred__47761,expr__47762))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__47765){
var map__47766 = p__47765;
...
var opts = map__47766__$1;
var eval_fn = cljs.core.get.call(null,map__47766__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__47768_SHARP_){
return new_def.callback(p1__47768_SHARP_);
});})(new_def))
);
...
return (function (p__47769){
var vec__47770 = p__47769;
var ky = cljs.core.nth.call(null,vec__47770,(0),null);
var v = cljs.core.nth.call(null,vec__47770,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1563379480366
