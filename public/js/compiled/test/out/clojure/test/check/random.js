...
return m__4434__auto__.call(null,rng);
} else {
var m__4431__auto__ = (clojure.test.check.random.rand_long["_"]);
if((!((m__4431__auto__ == null)))){
return m__4431__auto__.call(null,rng);
} else {
...
if((!((m__4434__auto__ == null)))){
return m__4434__auto__.call(null,rng,n);
} else {
var m__4431__auto__ = (clojure.test.check.random.split_n["_"]);
if((!((m__4431__auto__ == null)))){
return m__4431__auto__.call(null,rng,n);
} else {
...
return clojure.test.check.random.longs.bit_xor.call(null,G__6897,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__6897;
}
});
...
var G__6900 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__6901 = cljs.core.conj_BANG_.call(null,ret,new_rng);
state__$1 = G__6900;
ret = G__6901;
continue;
}
...
return cljs.core._write.call(null,writer__4375__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
});
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__4131__auto__ = clojure.test.check.random.longs.__GT_long.call(null,seed);
...
var state = cljs.core.get.call(null,map__6903__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__6905 = clojure.test.check.random.split.call(null,state);
var r1 = cljs.core.nth.call(null,vec__6905,(0),null);
var r2 = cljs.core.nth.call(null,vec__6905,(1),null);
