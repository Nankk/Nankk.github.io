...
var G__2949 = (root.arr[(slc - (1))]);
var G__2950 = (shift - (5));
var G__2951 = (((rngs[(31)]) - (rngs[(30)])) + (32));
root = G__2949;
shift = G__2950;
cnt = G__2951;
continue;
...
if((!(r_QMARK_))){
var rngs_2960 = clojure.core.rrb_vector.nodes.ranges.call(null,parent);
var rng0_2961 = (rngs_2960[(0)]);
var new_rngs_2962 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
var lim_2963 = (rngs_2960[(32)]);
cljs.core.array_copy.call(null,rngs_2960,(1),new_rngs_2962,(0),(lim_2963 - (1)));

var i_2964 = (0);
while(true){
if((i_2964 < lim_2963)){
(new_rngs_2962[i_2964] = ((new_rngs_2962[i_2964]) - rng0_2961));

var G__2965 = (i_2964 + (1));
i_2964 = G__2965;
continue;
} else {
}
...
(new_rngs_2962[(32)] = ((rngs_2960[(32)]) - (1)));

(new_rngs_2962[((rngs_2960[(32)]) - (1))] = (0));

(new_arr[(32)] = new_rngs_2962);
} else {
}
...
while(true){
if((i_2966 <= li)){
(new_rngs[i_2966] = ((new_rngs[(i_2966 - (1))]) + step));

var G__2967 = (i_2966 + (1));
i_2966 = G__2967;
continue;
} else {
}
...
while(true){
if((i_2968 <= li)){
(new_rngs[i_2968] = ((rngs[i_2968]) - d));

var G__2969 = (i_2968 + (1));
i_2968 = G__2969;
continue;
} else {
}
...
var G__2972 = (j_2970 + (1));
var G__2973 = (r_2971 + step);
j_2970 = G__2972;
r_2971 = G__2973;
continue;
} else {
...
var rngs = (((!(reg_QMARK_)))?(function (){var G__2974 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
(G__2974[(0)] = node.arr.length);
...
var arr_2975__$1 = arr;
var shift_2976__$1 = shift;
while(true){
if((shift_2976__$1 === (5))){
if((!(reg_QMARK_))){
(arr_2975__$1[(32)] = rngs);
} else {
}

(arr_2975__$1[(0)] = node);
} else {
var a_2977 = (new Array(len));
var e_2978 = cljs.core.__GT_VectorNode.call(null,null,a_2977);
(arr_2975__$1[(0)] = e_2978);
...
var G__2979 = a_2977;
var G__2980 = (shift_2976__$1 - (5));
arr_2975__$1 = G__2979;
shift_2976__$1 = G__2980;
continue;
}
break;
}
