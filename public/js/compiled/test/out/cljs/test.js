...
var G__2234 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__2234,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__2234;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq2236){
var G__2237 = cljs.core.first.call(null,seq2236);
var seq2236__$1 = cljs.core.next.call(null,seq2236);
var G__2238 = cljs.core.first.call(null,seq2236__$1);
var seq2236__$2 = cljs.core.next.call(null,seq2236__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__2237,G__2238,seq2236__$2);
});
...
var map__2243 = m;
var map__2243__$1 = (((((!((map__2243 == null))))?(((((map__2243.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2243.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2243):map__2243);
var file = cljs.core.get.call(null,map__2243__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__2243__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__2243__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__2243,map__2243__$1,file,line,column){
return (function (p1__2242_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__2242_SHARP_));
});})(map__2243,map__2243__$1,file,line,column))
...
var temp__5735__auto___2245 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___2245)){
var message_2246 = temp__5735__auto___2245;
cljs.core.println.call(null,message_2246);
} else {
}
...
var temp__5735__auto___2247 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___2247)){
var message_2248 = temp__5735__auto___2247;
cljs.core.println.call(null,message_2248);
} else {
}
...
var output_dir = "resources/public/js/compiled/test/out";
var output_dir__$1 = (function (){var G__2249 = output_dir;
...
var G__2251 = exception.stack;
var G__2251__$1 = (((G__2251 == null))?null:clojure.string.split_lines.call(null,G__2251));
var G__2251__$2 = (((G__2251__$1 == null))?null:cljs.core.get.call(null,G__2251__$1,depth));
if((G__2251__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__2251__$2);
}
} else {
...
var vec__2252 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__2252,(0),null);
var column = cljs.core.nth.call(null,vec__2252,(1),null);
var vec__2255 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__2255,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__2255,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__2255,(2),null);
...
var m__$1 = (function (){var G__2258 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__2258__$1 = (((G__2258 instanceof cljs.core.Keyword))?G__2258.fqn:null);
switch (G__2258__$1) {
case "fail":
...
var G__2262 = (function (){var G__2261 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__2261);
} else {
return G__2261;
}
})();
...
return cljs.core.vary_meta.call(null,G__2263,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e2264){var e = e2264;
var G__2265 = e;
var G__2265__$1 = (((G__2265 instanceof cljs.core.Keyword))?G__2265.fqn:null);
switch (G__2265__$1) {
...
var vec__2267 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__2267,(0),null);
var types = vec__2267;
...
return cljs.core.map.call(null,(function (p__2270){
var vec__2271 = p__2270;
var ns = cljs.core.nth.call(null,vec__2271,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__2271,(1),null);
return ((function (vec__2271,ns,vars__$1){
return (function (){
...
var G__2274 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__2274__$1 = (((G__2274 instanceof cljs.core.Keyword))?G__2274.fqn:null);
switch (G__2274__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__2274,G__2274__$1,env,once_fixtures,each_fixtures,vec__2271,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__2274,G__2274__$1,env,once_fixtures,each_fixtures,vec__2271,ns,vars__$1){
return (function (){
var seq__2275 = cljs.core.seq.call(null,vars__$1);
var chunk__2276 = null;
var count__2277 = (0);
var i__2278 = (0);
while(true){
if((i__2278 < count__2277)){
var v = cljs.core._nth.call(null,chunk__2276,i__2278);
var temp__5735__auto___2280 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___2280)){
var t_2281 = temp__5735__auto___2280;
each_fixture_fn.call(null,((function (seq__2275,chunk__2276,count__2277,i__2278,t_2281,temp__5735__auto___2280,v,each_fixture_fn,G__2274,G__2274__$1,env,once_fixtures,each_fixtures,vec__2271,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_2281)));
});})(seq__2275,chunk__2276,count__2277,i__2278,t_2281,temp__5735__auto___2280,v,each_fixture_fn,G__2274,G__2274__$1,env,once_fixtures,each_fixtures,vec__2271,ns,vars__$1))
);
} else {
}


var G__2282 = seq__2275;
var G__2283 = chunk__2276;
var G__2284 = count__2277;
var G__2285 = (i__2278 + (1));
seq__2275 = G__2282;
chunk__2276 = G__2283;
count__2277 = G__2284;
i__2278 = G__2285;
...
var temp__5735__auto__ = cljs.core.seq.call(null,seq__2275);
if(temp__5735__auto__){
var seq__2275__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__2275__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__2275__$1);
var G__2286 = cljs.core.chunk_rest.call(null,seq__2275__$1);
var G__2287 = c__4550__auto__;
var G__2288 = cljs.core.count.call(null,c__4550__auto__);
var G__2289 = (0);
seq__2275 = G__2286;
chunk__2276 = G__2287;
count__2277 = G__2288;
...
var v = cljs.core.first.call(null,seq__2275__$1);
var temp__5735__auto___2290__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___2290__$1)){
var t_2291 = temp__5735__auto___2290__$1;
each_fixture_fn.call(null,((function (seq__2275,chunk__2276,count__2277,i__2278,t_2291,temp__5735__auto___2290__$1,v,seq__2275__$1,temp__5735__auto__,each_fixture_fn,G__2274,G__2274__$1,env,once_fixtures,each_fixtures,vec__2271,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_2291)));
});})(seq__2275,chunk__2276,count__2277,i__2278,t_2291,temp__5735__auto___2290__$1,v,seq__2275__$1,temp__5735__auto__,each_fixture_fn,G__2274,G__2274__$1,env,once_fixtures,each_fixtures,vec__2271,ns,vars__$1))
);
} else {
}


var G__2292 = cljs.core.next.call(null,seq__2275__$1);
var G__2293 = null;
var G__2294 = (0);
var G__2295 = (0);
seq__2275 = G__2292;
...
});})(each_fixture_fn,G__2274,G__2274__$1,env,once_fixtures,each_fixtures,vec__2271,ns,vars__$1))
);
});})(each_fixture_fn,G__2274,G__2274__$1,env,once_fixtures,each_fixtures,vec__2271,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__2274__$1)].join('')));

}
})());
});
;})(vec__2271,ns,vars__$1))
