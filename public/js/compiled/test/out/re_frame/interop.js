...
return [(function (){var pred__2938 = cljs.core.instance_QMARK_;
var expr__2939 = reactive_val;
if(cljs.core.truth_(pred__2938.call(null,reagent.ratom.RAtom,expr__2939))){
return "ra";
} else {
if(cljs.core.truth_(pred__2938.call(null,reagent.ratom.RCursor,expr__2939))){
return "rc";
} else {
if(cljs.core.truth_(pred__2938.call(null,reagent.ratom.Reaction,expr__2939))){
return "rx";
} else {
if(cljs.core.truth_(pred__2938.call(null,reagent.ratom.Track,expr__2939))){
return "tr";
} else {
return "other";
}
