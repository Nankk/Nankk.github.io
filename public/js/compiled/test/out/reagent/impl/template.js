...
var G__2771 = o;
(G__2771[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__2772__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__2772 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__2773__i = 0, G__2773__a = new Array(arguments.length -  0);
while (G__2773__i < G__2773__a.length) {G__2773__a[G__2773__i] = arguments[G__2773__i + 0]; ++G__2773__i;}
  args = new cljs.core.IndexedSeq(G__2773__a,0,null);
} 
return G__2772__delegate.call(this,args);};
G__2772.cljs$lang$maxFixedArity = 0;
G__2772.cljs$lang$applyTo = (function (arglist__2774){
var args = cljs.core.seq(arglist__2774);
return G__2772__delegate(args);
});
G__2772.cljs$core$IFn$_invoke$arity$variadic = G__2772__delegate;
return G__2772;
})()
;
} else {
...
var G__2775 = o;
(G__2775[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__2780 = props;
var G__2780__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__2780,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__2780);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__2780__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__2781){
var map__2782 = p__2781;
var map__2782__$1 = (((((!((map__2782 == null))))?(((((map__2782.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2782.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2782):map__2782);
var props = map__2782__$1;
var class$ = cljs.core.get.call(null,map__2782__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__2782,map__2782__$1,props,class$){
return (function (c){
...
});})(map__2782,map__2782__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__2784){
var map__2785 = p__2784;
var map__2785__$1 = (((((!((map__2785 == null))))?(((((map__2785.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2785.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2785):map__2785);
var on_write = cljs.core.get.call(null,map__2785__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__2785,map__2785__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__2785,map__2785__$1,on_write))
);
} else {
...
var G__2788 = jsprops;
(G__2788["defaultValue"] = value);

(G__2788["onChange"] = ((function (G__2788,v,value,on_change){
return (function (p1__2787_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__2787_SHARP_);
});})(G__2788,v,value,on_change))
);
...
var vec__2791 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__2791,(0),null);
var id = cljs.core.nth.call(null,vec__2791,(1),null);
var class$ = cljs.core.nth.call(null,vec__2791,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___2795 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___2795 == null)){
} else {
var key_2796 = temp__5739__auto___2795;
(jsprops["key"] = key_2796);
}
...
var temp__5739__auto___2797 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___2797 == null)){
} else {
var key_2798 = temp__5739__auto___2797;
reagent.impl.template.oset.call(null,jsprops,"key",key_2798);
}
...
var G__2799 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__2799["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq2803){
var G__2804 = cljs.core.first.call(null,seq2803);
var seq2803__$1 = cljs.core.next.call(null,seq2803);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__2804,seq2803__$1);
});
...
break;
default:
var G__2810 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__2810;
continue;
...
var n__4607__auto___2812 = a.length;
var i_2813 = (0);
while(true){
if((i_2813 < n__4607__auto___2812)){
(a[i_2813] = reagent.impl.template.as_element.call(null,(a[i_2813])));
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___2815 = a.length;
var i_2816 = (0);
while(true){
if((i_2816 < n__4607__auto___2815)){
var val_2817 = (a[i_2816]);
if(((cljs.core.vector_QMARK_.call(null,val_2817)) && ((reagent.impl.template.key_from_vec.call(null,val_2817) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_2816] = reagent.impl.template.as_element.call(null,val_2817));

var G__2818 = (i_2816 + (1));
i_2816 = G__2818;
continue;
} else {
}
...
var ctx = ({});
var vec__2819 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__2819,(0),null);
var derefed = cljs.core.nth.call(null,vec__2819,(1),null);
...
var G__2822 = (cljs.core.count.call(null,argv) - first_child);
switch (G__2822) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__2822){
