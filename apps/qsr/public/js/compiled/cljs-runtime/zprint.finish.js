...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__40826_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__40826_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__40826_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__40827){
var vec__40828 = p__40827;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40828,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40828,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__40831,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40832__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40832__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40832__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__40836 = (function (){var or__4131__auto__ = color;
...
var fexpr__40835 = (function (){var G__40837 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__40837) : style_map.call(null,G__40837));
})();
return (fexpr__40835.cljs$core$IFn$_invoke$arity$1 ? fexpr__40835.cljs$core$IFn$_invoke$arity$1(G__40836) : fexpr__40835.call(null,G__40836));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__40838){
var vec__40839 = p__40838;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40839,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40839,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40839,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__40844){
var vec__40845 = p__40844;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40845,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40845,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40845,(2),null);
...
var G__40989 = cljs.core.next(ssv);
var G__40990 = (this_ssv == null);
var G__40991 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__40992 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__40989;
doing_nil_QMARK_ = G__40990;
last_elide = G__40991;
out = G__40992;
continue;
}
...
var vec__40864 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40864,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40864,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40864,(2),null);
...
var G__40996 = cljs.core.next(remaining_cvec);
var G__40997 = new_idx;
var G__40998 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__40996;
idx = G__40997;
out = G__40998;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__40913,cursor_vec){
var vec__40914 = p__40913;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40914,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40914,(1),null);
var focus_vec = vec__40914;
...
var vec__40917 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40917,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40917,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__40920){
var vec__40921 = p__40920;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40921,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40921,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__40931,existing_count){
var vec__40932 = p__40931;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40932,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40932,(1),null);
...
return cljs.core.filterv(((function (s__$1,len,cursor__$1,vec__40932,s,cursor){
return (function (p1__40924_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__40924_SHARP_))));
});})(s__$1,len,cursor__$1,vec__40932,s,cursor))
...
var vec__40951 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40951,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40951,(1),null);
var cvec_element = vec__40951;
if((cvec_element == null)){
var G__41020 = cljs.core.next(cvec_nl);
var G__41021 = (idx + (1));
var G__41022 = start;
var G__41023 = out;
cvec_nl = G__41020;
...
var G__41024 = cljs.core.next(cvec_nl);
var G__41025 = (idx + (1));
var G__41026 = idx;
var G__41027 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__41024;
idx = G__41025;
start = G__41026;
out = G__41027;
...
var G__41029 = cljs.core.next(cvec_nl);
var G__41030 = (idx + (1));
var G__41031 = (idx + (1));
var G__41032 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__41029;
idx = G__41030;
start = G__41031;
out = G__41032;
...
var G__41034 = cljs.core.next(cvec_nl);
var G__41035 = (idx + (1));
var G__41036 = idx;
var G__41037 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__41034;
idx = G__41035;
start = G__41036;
out = G__41037;
...
var G__41038 = cljs.core.next(cvec_nl);
var G__41039 = (idx + (1));
var G__41040 = start;
var G__41041 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__41038;
idx = G__41039;
start = G__41040;
out = G__41041;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__40956_SHARP_,p2__40955_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__40955_SHARP_)){
return cljs.core.reduced(p1__40956_SHARP_);
} else {
return (p1__40956_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__40957,p__40958){
var vec__40959 = p__40957;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40959,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40959,(1),null);
var vec__40962 = p__40958;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40962,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40962,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__40966,cvec,focus_vec){
...
var options = map__40967__$1;
var map__40968 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40967__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__40968__$1 = (((((!((map__40968 == null))))?(((((map__40968.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40968.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40968):map__40968);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40968__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40968__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40968__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__40967,map__40967__$1,options,map__40968,map__40968__$1,focus,lines,paths){
return (function (p1__40965_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__40965_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__40967,map__40967__$1,options,map__40968,map__40968__$1,focus,lines,paths))
,path_vecs);
