...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__40648_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__40648_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__40648_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__40649){
var vec__40650 = p__40649;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40650,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40650,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__40655,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40656__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40656__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40656__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__40660 = (function (){var or__4131__auto__ = color;
...
var fexpr__40659 = (function (){var G__40661 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__40661) : style_map.call(null,G__40661));
})();
return (fexpr__40659.cljs$core$IFn$_invoke$arity$1 ? fexpr__40659.cljs$core$IFn$_invoke$arity$1(G__40660) : fexpr__40659.call(null,G__40660));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__40662){
var vec__40663 = p__40662;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40663,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40663,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40663,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__40667){
var vec__40668 = p__40667;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40668,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40668,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40668,(2),null);
...
var G__40922 = cljs.core.next(ssv);
var G__40923 = (this_ssv == null);
var G__40924 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__40925 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__40922;
doing_nil_QMARK_ = G__40923;
last_elide = G__40924;
out = G__40925;
continue;
}
...
var vec__40680 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40680,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40680,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40680,(2),null);
...
var G__40929 = cljs.core.next(remaining_cvec);
var G__40930 = new_idx;
var G__40931 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__40929;
idx = G__40930;
out = G__40931;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__40741,cursor_vec){
var vec__40748 = p__40741;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40748,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40748,(1),null);
var focus_vec = vec__40748;
...
var vec__40751 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40751,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40751,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__40868){
var vec__40869 = p__40868;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40869,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40869,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__40875,existing_count){
var vec__40876 = p__40875;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40876,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40876,(1),null);
...
return cljs.core.filterv(((function (s__$1,len,cursor__$1,vec__40876,s,cursor){
return (function (p1__40872_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__40872_SHARP_))));
});})(s__$1,len,cursor__$1,vec__40876,s,cursor))
...
var vec__40884 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40884,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40884,(1),null);
var cvec_element = vec__40884;
if((cvec_element == null)){
var G__40947 = cljs.core.next(cvec_nl);
var G__40948 = (idx + (1));
var G__40949 = start;
var G__40950 = out;
cvec_nl = G__40947;
...
var G__40953 = cljs.core.next(cvec_nl);
var G__40954 = (idx + (1));
var G__40955 = idx;
var G__40956 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__40953;
idx = G__40954;
start = G__40955;
out = G__40956;
...
var G__40958 = cljs.core.next(cvec_nl);
var G__40959 = (idx + (1));
var G__40960 = (idx + (1));
var G__40961 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__40958;
idx = G__40959;
start = G__40960;
out = G__40961;
...
var G__40963 = cljs.core.next(cvec_nl);
var G__40964 = (idx + (1));
var G__40965 = idx;
...
var G__40967 = cljs.core.next(cvec_nl);
var G__40968 = (idx + (1));
var G__40969 = start;
var G__40970 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__40967;
idx = G__40968;
start = G__40969;
out = G__40970;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__40889_SHARP_,p2__40888_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__40888_SHARP_)){
return cljs.core.reduced(p1__40889_SHARP_);
} else {
return (p1__40889_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__40890,p__40891){
var vec__40892 = p__40890;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40892,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40892,(1),null);
var vec__40895 = p__40891;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40895,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40895,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__40908,cvec,focus_vec){
...
var options = map__40909__$1;
var map__40910 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40909__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40910__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40910__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40910__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__40909,map__40909__$1,options,map__40910,map__40910__$1,focus,lines,paths){
return (function (p1__40907_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__40907_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__40909,map__40909__$1,options,map__40910,map__40910__$1,focus,lines,paths))
,path_vecs);
