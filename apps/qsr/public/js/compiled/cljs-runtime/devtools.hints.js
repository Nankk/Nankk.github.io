...
var G__31023 = cljs.core.PersistentArrayMap.EMPTY;
var G__31024 = native_stack_trace;
var G__31025 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__31026 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__31023,G__31024,G__31025,G__31026) : cljs.stacktrace.parse_stacktrace.call(null,G__31023,G__31024,G__31025,G__31026));
});
...
var map__31032 = top_item;
var map__31032__$1 = (((((!((map__31032 == null))))?(((((map__31032.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__31032.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__31032):map__31032);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31032__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31032__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31032__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e31031){var _e = e31031;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___31082 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___31082)){
var seen_errors_31083 = temp__5733__auto___31082;
if(cljs.core.truth_(seen_errors_31083.has(self))){
} else {
seen_errors_31083.add(self);

var temp__5735__auto___31084 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___31084)){
var sense_31085 = temp__5735__auto___31084;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_31085)].join('');
} else {
}
}
} else {
