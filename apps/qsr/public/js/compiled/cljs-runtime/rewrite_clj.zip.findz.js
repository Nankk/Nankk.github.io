...
var len__4730__auto___40471 = arguments.length;
var i__4731__auto___40472 = (0);
while(true){
if((i__4731__auto___40472 < len__4730__auto___40471)){
args__4736__auto__.push((arguments[i__4731__auto___40472]));

var G__40473 = (i__4731__auto___40472 + (1));
i__4731__auto___40472 = G__40473;
continue;
} else {
}
break;
...
rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__40382){
var vec__40383 = p__40382;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40383,(0),null);
if(cljs.core.truth_(additional)){
return ((function (vec__40383,additional){
...
;})(vec__40383,additional))
} else {
return ((function (vec__40383,additional){
return (function (p1__40374_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__40374_SHARP_),t);
});
;})(vec__40383,additional))
}
});
...
/** @this {Function} */
rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq40376){
var G__40377 = cljs.core.first(seq40376);
var seq40376__$1 = cljs.core.next(seq40376);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40377,seq40376__$1);
});

rewrite_clj.zip.findz.in_range_QMARK_ = (function rewrite_clj$zip$findz$in_range_QMARK_(p__40387,p__40388){
var map__40389 = p__40387;
...
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40389__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40389__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40389__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40389__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
var map__40390 = p__40388;
...
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40390__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40390__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__40424_SHARP_){
var and__4120__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__40424_SHARP_) : p_QMARK_.call(null,p1__40424_SHARP_));
if(cljs.core.truth_(and__4120__auto__)){
return rewrite_clj.zip.findz.in_range_QMARK_(cljs.core.meta(clojure.zip.node(p1__40424_SHARP_)),pos);
} else {
return and__4120__auto__;
}
...
var G__40431 = zloc;
var G__40431__$1 = (((G__40431 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__40431) : f.call(null,G__40431)));
if((G__40431__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__40431__$1,f,p_QMARK_);
}
});
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__40432_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__40432_SHARP_),t);
}));
});
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__40443_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__40443_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__40449_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__40449_SHARP_),v);
}));
