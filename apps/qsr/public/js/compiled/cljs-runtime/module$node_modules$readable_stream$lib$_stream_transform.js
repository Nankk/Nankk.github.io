...
global=require("module$node_modules$util$util");global.inherits=require("module$node_modules$inherits$inherits_browser");global.inherits(Transform,Duplex);Transform.prototype.push=function(chunk,encoding){this._transformState.needTransform=!1;return Duplex.prototype.push.call(this,chunk,encoding)};Transform.prototype._transform=function(chunk,encoding,cb){throw Error("_transform() is not implemented");};Transform.prototype._write=function(chunk,encoding,cb){var ts=this._transformState;ts.writecb=
cb;ts.writechunk=chunk;ts.writeencoding=encoding;ts.transforming||(chunk=this._readableState,(ts.needTransform||chunk.needReadable||chunk.length<chunk.highWaterMark)&&this._read(chunk.highWaterMark))};Transform.prototype._read=function(n){n=this._transformState;null!==n.writechunk&&n.writecb&&!n.transforming?(n.transforming=!0,this._transform(n.writechunk,n.writeencoding,n.afterTransform)):n.needTransform=!0};Transform.prototype._destroy=function(err,cb){var _this2=this;Duplex.prototype._destroy.call(this,
