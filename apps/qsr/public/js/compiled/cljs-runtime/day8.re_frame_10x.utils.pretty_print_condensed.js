...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(string,(0),(function (){var G__41215 = per_side_budget;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41212__$1)].join('')));
...
var G__41252 = clojure.string.replace(s,match,trunc_prefix);
var G__41253 = limit;
var G__41254 = match;
var G__41255 = trunc_prefix;
s = G__41252;
limit = G__41253;
match = G__41254;
trunc_prefix = G__41255;
continue;
}
}
break;
...
var prefix = (function (){var G__41218 = ((kw_QMARK_)?":":"");
if(cljs.core.truth_(the_ns)){
return [G__41218,"\u2026/"].join('');
} else {
return G__41218;
}
})();
...
var vec__41220 = day8.re_frame_10x.utils.pretty_print_condensed.edges(coll);
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41220,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41220,(1),null);
...
var or__4131__auto__ = (function (){var G__41227 = form.name;
if((G__41227 == null)){
return null;
} else {
return clojure.string.replace(G__41227,/(^.*\$)(.*)/,"$2");
}
})();
...
var G__41229 = obj;
var G__41230 = writer;
var G__41231 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(opts,new cljs.core.Keyword(null,"fallback-impl","fallback-impl",-1501286995),day8.re_frame_10x.utils.pretty_print_condensed.pr_writer_impl);
return (alt_impl.cljs$core$IFn$_invoke$arity$3 ? alt_impl.cljs$core$IFn$_invoke$arity$3(G__41229,G__41230,G__41231) : alt_impl.call(null,G__41229,G__41230,G__41231));
} else {
...
var seq__41232 = cljs.core.seq(cljs.core.next(objs));
var chunk__41233 = null;
var count__41234 = (0);
var i__41235 = (0);
while(true){
if((i__41235 < count__41234)){
var obj = chunk__41233.cljs$core$IIndexed$_nth$arity$2(null,i__41235);
cljs.core._write(writer," ");

day8.re_frame_10x.utils.pretty_print_condensed.pr_writer(obj,writer,opts);


var G__41272 = seq__41232;
var G__41273 = chunk__41233;
var G__41274 = count__41234;
var G__41275 = (i__41235 + (1));
seq__41232 = G__41272;
chunk__41233 = G__41273;
count__41234 = G__41274;
i__41235 = G__41275;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__41232);
if(temp__5735__auto__){
var seq__41232__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__41232__$1)){
var c__4550__auto__ = cljs.core.chunk_first(seq__41232__$1);
var G__41276 = cljs.core.chunk_rest(seq__41232__$1);
var G__41277 = c__4550__auto__;
var G__41278 = cljs.core.count(c__4550__auto__);
var G__41279 = (0);
seq__41232 = G__41276;
chunk__41233 = G__41277;
count__41234 = G__41278;
i__41235 = G__41279;
continue;
} else {
var obj = cljs.core.first(seq__41232__$1);
cljs.core._write(writer," ");

day8.re_frame_10x.utils.pretty_print_condensed.pr_writer(obj,writer,opts);


var G__41280 = cljs.core.next(seq__41232__$1);
var G__41281 = null;
var G__41282 = (0);
var G__41283 = (0);
seq__41232 = G__41280;
chunk__41233 = G__41281;
count__41234 = G__41282;
i__41235 = G__41283;
continue;
}
} else {
...
var len__4730__auto___41290 = arguments.length;
var i__4731__auto___41291 = (0);
while(true){
if((i__4731__auto___41291 < len__4730__auto___41290)){
args__4736__auto__.push((arguments[i__4731__auto___41291]));

var G__41292 = (i__4731__auto___41291 + (1));
i__4731__auto___41291 = G__41292;
continue;
} else {
}
break;
...
/** @this {Function} */
day8.re_frame_10x.utils.pretty_print_condensed.pr_str_truncated.cljs$lang$applyTo = (function (seq41239){
var G__41240 = cljs.core.first(seq41239);
var seq41239__$1 = cljs.core.next(seq41239);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41240,seq41239__$1);
});
