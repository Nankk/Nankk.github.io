...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(string,(0),(function (){var G__41038 = per_side_budget;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41034__$1)].join('')));
...
var G__41065 = clojure.string.replace(s,match,trunc_prefix);
var G__41066 = limit;
var G__41067 = match;
var G__41068 = trunc_prefix;
s = G__41065;
limit = G__41066;
match = G__41067;
trunc_prefix = G__41068;
continue;
}
}
break;
...
var prefix = (function (){var G__41041 = ((kw_QMARK_)?":":"");
if(cljs.core.truth_(the_ns)){
return [G__41041,"\u2026/"].join('');
} else {
return G__41041;
}
})();
...
var vec__41043 = day8.re_frame_10x.utils.pretty_print_condensed.edges(coll);
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41043,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41043,(1),null);
...
var or__4131__auto__ = (function (){var G__41050 = form.name;
if((G__41050 == null)){
return null;
} else {
return clojure.string.replace(G__41050,/(^.*\$)(.*)/,"$2");
}
})();
...
var G__41052 = obj;
var G__41053 = writer;
var G__41054 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(opts,new cljs.core.Keyword(null,"fallback-impl","fallback-impl",-1501286995),day8.re_frame_10x.utils.pretty_print_condensed.pr_writer_impl);
return (alt_impl.cljs$core$IFn$_invoke$arity$3 ? alt_impl.cljs$core$IFn$_invoke$arity$3(G__41052,G__41053,G__41054) : alt_impl.call(null,G__41052,G__41053,G__41054));
} else {
...
var seq__41055 = cljs.core.seq(cljs.core.next(objs));
var chunk__41056 = null;
var count__41057 = (0);
var i__41058 = (0);
while(true){
if((i__41058 < count__41057)){
var obj = chunk__41056.cljs$core$IIndexed$_nth$arity$2(null,i__41058);
cljs.core._write(writer," ");

day8.re_frame_10x.utils.pretty_print_condensed.pr_writer(obj,writer,opts);


var G__41070 = seq__41055;
var G__41071 = chunk__41056;
var G__41072 = count__41057;
var G__41073 = (i__41058 + (1));
seq__41055 = G__41070;
chunk__41056 = G__41071;
count__41057 = G__41072;
i__41058 = G__41073;
continue;
} else {
...
var G__41074 = cljs.core.chunk_rest(seq__41055__$1);
var G__41075 = c__4550__auto__;
var G__41076 = cljs.core.count(c__4550__auto__);
var G__41077 = (0);
seq__41055 = G__41074;
chunk__41056 = G__41075;
count__41057 = G__41076;
i__41058 = G__41077;
continue;
} else {
var obj = cljs.core.first(seq__41055__$1);
cljs.core._write(writer," ");

day8.re_frame_10x.utils.pretty_print_condensed.pr_writer(obj,writer,opts);


var G__41078 = cljs.core.next(seq__41055__$1);
var G__41079 = null;
var G__41080 = (0);
var G__41081 = (0);
seq__41055 = G__41078;
chunk__41056 = G__41079;
count__41057 = G__41080;
i__41058 = G__41081;
continue;
}
} else {
...
var len__4730__auto___41082 = arguments.length;
var i__4731__auto___41083 = (0);
while(true){
if((i__4731__auto___41083 < len__4730__auto___41082)){
args__4736__auto__.push((arguments[i__4731__auto___41083]));

var G__41084 = (i__4731__auto___41083 + (1));
i__4731__auto___41083 = G__41084;
continue;
} else {
}
break;
...
/** @this {Function} */
day8.re_frame_10x.utils.pretty_print_condensed.pr_str_truncated.cljs$lang$applyTo = (function (seq41059){
var G__41060 = cljs.core.first(seq41059);
var seq41059__$1 = cljs.core.next(seq41059);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41060,seq41059__$1);
});
