...
exports=require("module$node_modules$process$browser");"use strict";var pna=require("module$node_modules$process_nextick_args$index");module.exports=Writable;var asyncWrite=!exports.browser&&-1<["v0.10","v0.9."].indexOf(exports.version.slice(0,5))?setImmediate:pna.nextTick,Duplex;Writable.WritableState=WritableState;module=require("module$node_modules$util$util");module.inherits=require("module$node_modules$inherits$inherits_browser");var internalUtil={deprecate:require("module$node_modules$util_deprecate$browser")},
Stream=require("module$node_modules$readable_stream$lib$internal$streams$stream_browser"),Buffer=require("module$node_modules$safe_buffer$index").Buffer,OurUint8Array=global.Uint8Array||function(){};global=require("module$node_modules$readable_stream$lib$internal$streams$destroy");module.inherits(Writable,Stream);WritableState.prototype.getBuffer=function(){for(var current=this.bufferedRequest,out=[];current;)out.push(current),current=current.next;return out};(function(){try{Object.defineProperty(WritableState.prototype,
...
encoding)),chunk!==JSCompiler_temp&&(ret=!0,encoding="buffer",chunk=JSCompiler_temp)),JSCompiler_temp$jscomp$0=state.objectMode?1:chunk.length,state.length+=JSCompiler_temp$jscomp$0,JSCompiler_temp=state.length<state.highWaterMark,JSCompiler_temp||(state.needDrain=!0),state.writing||state.corked?(JSCompiler_temp$jscomp$0=state.lastBufferedRequest,state.lastBufferedRequest={chunk:chunk,encoding:encoding,isBuf:ret,callback:cb$jscomp$0,next:null},JSCompiler_temp$jscomp$0?JSCompiler_temp$jscomp$0.next=
