...
typeof callback&&(opts=callback,callback=void 0);opts=Object.assign({forceRefresh:!1},opts);if(callback){var cb=callback;this.getTokenAsync(opts).then(function(t){return cb(null,t)},callback)}else return this.getTokenAsync(opts)};global.prototype.getCredentials=function(keyFile){var mimeType,key,body,privateKey,clientEmail,privateKey$20,privateKey$21;return $jscomp.asyncExecutePromiseGeneratorProgram(function($jscomp$generator$context){switch($jscomp$generator$context.nextAddress){case 1:switch(mimeType=
...
"utf8"),6);case 6:key=$jscomp$generator$context.yieldResult;body=JSON.parse(key);privateKey=body.private_key;clientEmail=body.client_email;if(!privateKey||!clientEmail)throw new ErrorWithCode("private_key and client_email are required.","MISSING_CREDENTIALS");return $jscomp$generator$context.return({privateKey:privateKey,clientEmail:clientEmail});case 3:return $jscomp$generator$context.yield(readFile(keyFile,"utf8"),7);case 7:return privateKey$20=$jscomp$generator$context.yieldResult,$jscomp$generator$context.return({privateKey:privateKey$20});
case 4:if(getPem){$jscomp$generator$context.jumpTo(8);break}return $jscomp$generator$context.yield(Promise.resolve().then(function(){return require("module$node_modules$google_p12_pem$build$src$index")}),9);case 9:getPem=$jscomp$generator$context.yieldResult.getPem;case 8:return $jscomp$generator$context.yield(getPem(keyFile),10);case 10:return privateKey$21=$jscomp$generator$context.yieldResult,$jscomp$generator$context.return({privateKey:privateKey$21})}})};global.prototype.getTokenAsync=function(opts){var $jscomp$async$this=
