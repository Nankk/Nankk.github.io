...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__42978_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__42978_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__42978_SHARP_) <= ending)));
}));
});
...
var G__42990 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("sub","dispose","sub/dispose",365440536),p1__43006_SHARP_);
});})(and__4120__auto__))
...
return cljs.core.assoc_in(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"operation","operation",-1267664310).cljs$core$IFn$_invoke$arity$1(trace),new cljs.core.Keyword(null,"layer","layer",-1601820589)], null),(cljs.core.truth_(cljs.core.some((function (p1__43022_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(app_db_id,p1__43022_SHARP_);
...
})),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__43027){
var vec__43028 = p__43027;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43028,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43028,(1),null);
...
var new_state = (function (){var G__43032 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
break;
case "sub/run":
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,reaction_id,((function (G__43032,G__43032__$1,tags,reaction_id,state){
...
});})(G__43032,G__43032__$1,tags,reaction_id,state))
);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__43032__$1)].join('')));
...
return (function (all_state,p__43034){
var vec__43035 = p__43034;
var sub_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43035,(0),null);
var sub_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43035,(1),null);
