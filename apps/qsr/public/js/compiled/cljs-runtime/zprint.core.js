...
var vec__41634 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__41637 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41637,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41637,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41634,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41634,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__41648){
var vec__41649 = p__41648;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41649,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41649,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41652,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41652,(1),null);
...
var vec__41656 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41656,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41656,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41656,(2),null);
var vec__41659 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41659,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41659,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41659,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__41663){
var vec__41664 = p__41663;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41664,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41664,(1),null);
...
var len__4730__auto___41720 = arguments.length;
var i__4731__auto___41721 = (0);
while(true){
if((i__4731__auto___41721 < len__4730__auto___41720)){
args__4736__auto__.push((arguments[i__4731__auto___41721]));

var G__41722 = (i__4731__auto___41721 + (1));
i__4731__auto___41721 = G__41722;
continue;
} else {
}
break;
...
var vec__41675 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41675,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41675,(1),null);
...
var G__41678 = zprint.core.parse_string_all_options(rest_options);
var G__41679 = zprint.core.czprint_str_internal;
var G__41680 = ":parse-string-all? call";
var G__41681 = (function (){var G__41682 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__41682) : zprint.zutil.edn_STAR_.call(null,G__41682));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__41678,G__41679,G__41680,G__41681) : zprint.core.process_multiple_forms.call(null,G__41678,G__41679,G__41680,G__41681));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__41683 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41683,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41683,(1),null);
...
/** @this {Function} */
zprint.core.czprint_str_internal.cljs$lang$applyTo = (function (seq41672){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41673,G__41674,seq41672__$2);
});
...
var args__4736__auto__ = [];
var len__4730__auto___41729 = arguments.length;
var i__4731__auto___41730 = (0);
while(true){
if((i__4731__auto___41730 < len__4730__auto___41729)){
args__4736__auto__.push((arguments[i__4731__auto___41730]));

var G__41731 = (i__4731__auto___41730 + (1));
i__4731__auto___41730 = G__41731;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.zprint_str.cljs$lang$applyTo = (function (seq41689){
var G__41690 = cljs.core.first(seq41689);
var seq41689__$1 = cljs.core.next(seq41689);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41690,seq41689__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___41733 = arguments.length;
var i__4731__auto___41734 = (0);
while(true){
if((i__4731__auto___41734 < len__4730__auto___41733)){
args__4736__auto__.push((arguments[i__4731__auto___41734]));

var G__41735 = (i__4731__auto___41734 + (1));
i__4731__auto___41734 = G__41735;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.czprint_str.cljs$lang$applyTo = (function (seq41691){
var G__41692 = cljs.core.first(seq41691);
var seq41691__$1 = cljs.core.next(seq41691);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41692,seq41691__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___41742 = arguments.length;
var i__4731__auto___41743 = (0);
while(true){
if((i__4731__auto___41743 < len__4730__auto___41742)){
args__4736__auto__.push((arguments[i__4731__auto___41743]));

var G__41744 = (i__4731__auto___41743 + (1));
i__4731__auto___41743 = G__41744;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.zprint.cljs$lang$applyTo = (function (seq41693){
var G__41694 = cljs.core.first(seq41693);
var seq41693__$1 = cljs.core.next(seq41693);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41694,seq41693__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___41746 = arguments.length;
var i__4731__auto___41747 = (0);
while(true){
if((i__4731__auto___41747 < len__4730__auto___41746)){
args__4736__auto__.push((arguments[i__4731__auto___41747]));

var G__41752 = (i__4731__auto___41747 + (1));
i__4731__auto___41747 = G__41752;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.czprint.cljs$lang$applyTo = (function (seq41695){
var G__41696 = cljs.core.first(seq41695);
var seq41695__$1 = cljs.core.next(seq41695);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41696,seq41695__$1);
});
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__41698,form){
var vec__41699 = p__41698;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41699,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41699,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41699,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41699,(3),null);
...
var vec__41702 = (cljs.core.truth_((function (){var and__4120__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4120__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41702,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41702,(1),null);
...
var forms = (function (){var G__41707 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__41707) : zprint.zutil.edn_STAR_.call(null,G__41707));
})();
