...
var vec__41811 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__41814 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41814,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41814,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41811,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41811,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__41817){
var vec__41818 = p__41817;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41818,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41818,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41821,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41821,(1),null);
...
var vec__41833 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41833,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41833,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41833,(2),null);
var vec__41836 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41836,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41836,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41836,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__41840){
var vec__41841 = p__41840;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41841,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41841,(1),null);
...
var len__4730__auto___41897 = arguments.length;
var i__4731__auto___41898 = (0);
while(true){
if((i__4731__auto___41898 < len__4730__auto___41897)){
args__4736__auto__.push((arguments[i__4731__auto___41898]));

var G__41899 = (i__4731__auto___41898 + (1));
i__4731__auto___41898 = G__41899;
continue;
} else {
}
break;
...
var vec__41847 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41847,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41847,(1),null);
...
var G__41850 = zprint.core.parse_string_all_options(rest_options);
var G__41851 = zprint.core.czprint_str_internal;
var G__41852 = ":parse-string-all? call";
var G__41853 = (function (){var G__41854 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__41854) : zprint.zutil.edn_STAR_.call(null,G__41854));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__41850,G__41851,G__41852,G__41853) : zprint.core.process_multiple_forms.call(null,G__41850,G__41851,G__41852,G__41853));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__41860 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41860,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41860,(1),null);
...
/** @this {Function} */
zprint.core.czprint_str_internal.cljs$lang$applyTo = (function (seq41844){
var G__41845 = cljs.core.first(seq41844);
var seq41844__$1 = cljs.core.next(seq41844);
var G__41846 = cljs.core.first(seq41844__$1);
var seq41844__$2 = cljs.core.next(seq41844__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41845,G__41846,seq41844__$2);
});
...
/** @this {Function} */
zprint.core.zprint_str.cljs$lang$applyTo = (function (seq41866){
var G__41867 = cljs.core.first(seq41866);
var seq41866__$1 = cljs.core.next(seq41866);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41867,seq41866__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___41921 = arguments.length;
var i__4731__auto___41922 = (0);
while(true){
if((i__4731__auto___41922 < len__4730__auto___41921)){
args__4736__auto__.push((arguments[i__4731__auto___41922]));

var G__41923 = (i__4731__auto___41922 + (1));
i__4731__auto___41922 = G__41923;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.czprint_str.cljs$lang$applyTo = (function (seq41868){
var G__41869 = cljs.core.first(seq41868);
var seq41868__$1 = cljs.core.next(seq41868);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41869,seq41868__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___41924 = arguments.length;
var i__4731__auto___41925 = (0);
while(true){
if((i__4731__auto___41925 < len__4730__auto___41924)){
args__4736__auto__.push((arguments[i__4731__auto___41925]));

var G__41926 = (i__4731__auto___41925 + (1));
i__4731__auto___41925 = G__41926;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.zprint.cljs$lang$applyTo = (function (seq41870){
var G__41871 = cljs.core.first(seq41870);
var seq41870__$1 = cljs.core.next(seq41870);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41871,seq41870__$1);
});
...
/** @this {Function} */
zprint.core.czprint.cljs$lang$applyTo = (function (seq41872){
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__41875,form){
var vec__41876 = p__41875;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41876,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41876,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41876,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41876,(3),null);
...
var vec__41879 = (cljs.core.truth_((function (){var and__4120__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4120__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41879,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41879,(1),null);
...
var forms = (function (){var G__41884 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__41884) : zprint.zutil.edn_STAR_.call(null,G__41884));
})();
