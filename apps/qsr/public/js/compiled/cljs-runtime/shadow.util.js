...
var len__4730__auto___47768 = arguments.length;
var i__4731__auto___47769 = (0);
while(true){
if((i__4731__auto___47769 < len__4730__auto___47768)){
args__4736__auto__.push((arguments[i__4731__auto___47769]));

var G__47771 = (i__4731__auto___47769 + (1));
i__4731__auto___47769 = G__47771;
continue;
} else {
}
break;
...
/** @this {Function} */
shadow.util.go_BANG_.cljs$lang$applyTo = (function (seq47702){
...
args_arr__4751__auto__.push((arguments[i__4731__auto___47776]));

var G__47779 = (i__4731__auto___47776 + (1));
i__4731__auto___47776 = G__47779;
continue;
} else {
}
break;
...
/** @this {Function} */
shadow.util.log.cljs$lang$applyTo = (function (seq47720){
var G__47721 = cljs.core.first(seq47720);
var seq47720__$1 = cljs.core.next(seq47720);
var G__47722 = cljs.core.first(seq47720__$1);
var seq47720__$2 = cljs.core.next(seq47720__$1);
var G__47723 = cljs.core.first(seq47720__$2);
var seq47720__$3 = cljs.core.next(seq47720__$2);
var G__47724 = cljs.core.first(seq47720__$3);
var seq47720__$4 = cljs.core.next(seq47720__$3);
var G__47726 = cljs.core.first(seq47720__$4);
var seq47720__$5 = cljs.core.next(seq47720__$4);
var G__47727 = cljs.core.first(seq47720__$5);
var seq47720__$6 = cljs.core.next(seq47720__$5);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47721,G__47722,G__47723,G__47724,G__47726,G__47727,seq47720__$6);
});

shadow.util.log.cljs$lang$maxFixedArity = (6);

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__47750){
var vec__47752 = p__47750;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47752,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47752,(1),null);
