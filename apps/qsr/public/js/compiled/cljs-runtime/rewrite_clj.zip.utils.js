...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__40278,k,f){
var vec__40279 = p__40278;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40279,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40279,(1),null);
var loc = vec__40279;
...
var G__40312 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__40312;
continue;
}
break;
...
var G__40313 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__40313;
continue;
} else {
return zloc__$1;
...
var G__40314 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__40314;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__40288){
var vec__40289 = p__40288;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40289,(0),null);
var map__40292 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40289,(1),null);
var map__40292__$1 = (((((!((map__40292 == null))))?(((((map__40292.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40292.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40292):map__40292);
var path = map__40292__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40292__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__40289;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__40294){
...
var path = map__40298__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40298__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__40295;
if(cljs.core.seq(r)){
...
var vec__40304 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40304,(0),null);
var map__40307 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40304,(1),null);
...
var path = map__40307__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40307__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40307__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40307__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40307__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
