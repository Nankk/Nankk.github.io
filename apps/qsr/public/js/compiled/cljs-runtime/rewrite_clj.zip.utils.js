...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__40378,k,f){
var vec__40379 = p__40378;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40379,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40379,(1),null);
var loc = vec__40379;
...
var G__40420 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__40420;
continue;
}
break;
...
var G__40421 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__40421;
continue;
} else {
return zloc__$1;
...
var G__40422 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__40422;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__40391){
var vec__40392 = p__40391;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40392,(0),null);
var map__40395 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40392,(1),null);
var map__40395__$1 = (((((!((map__40395 == null))))?(((((map__40395.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40395.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40395):map__40395);
var path = map__40395__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40395__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__40392;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__40398){
var vec__40399 = p__40398;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40399,(0),null);
var map__40402 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40399,(1),null);
...
var path = map__40402__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40402__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__40399;
if(cljs.core.seq(r)){
...
var vec__40406 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40406,(0),null);
var map__40409 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40406,(1),null);
var map__40409__$1 = (((((!((map__40409 == null))))?(((((map__40409.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40409.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40409):map__40409);
var path = map__40409__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40409__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40409__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40409__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40409__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
