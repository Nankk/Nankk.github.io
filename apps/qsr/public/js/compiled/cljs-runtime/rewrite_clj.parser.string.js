...
if((c === "\n")){
var G__39971 = escape_QMARK_;
var G__39972 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__39971;
lines = G__39972;
continue;
} else {
buf.append(c);

var G__39973 = (((!(escape_QMARK_))) && ((c === "\\")));
var G__39974 = lines;
escape_QMARK_ = G__39973;
lines = G__39974;
continue;
...
var G__39966 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__39966) : rewrite_clj.node.string_node.call(null,G__39966));
});
...
var G__39967 = cljs.core.re_pattern(regex);
var G__39968 = ["#\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(regex),"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__39967,G__39968) : rewrite_clj.node.token_node.call(null,G__39967,G__39968));
});
