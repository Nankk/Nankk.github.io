...
return [(function (){var pred__42521 = cljs.core.instance_QMARK_;
var expr__42522 = reactive_val;
if(cljs.core.truth_((pred__42521.cljs$core$IFn$_invoke$arity$2 ? pred__42521.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__42522) : pred__42521.call(null,reagent.ratom.RAtom,expr__42522)))){
return "ra";
} else {
if(cljs.core.truth_((pred__42521.cljs$core$IFn$_invoke$arity$2 ? pred__42521.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__42522) : pred__42521.call(null,reagent.ratom.RCursor,expr__42522)))){
return "rc";
} else {
if(cljs.core.truth_((pred__42521.cljs$core$IFn$_invoke$arity$2 ? pred__42521.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__42522) : pred__42521.call(null,reagent.ratom.Reaction,expr__42522)))){
return "rx";
} else {
if(cljs.core.truth_((pred__42521.cljs$core$IFn$_invoke$arity$2 ? pred__42521.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__42522) : pred__42521.call(null,reagent.ratom.Track,expr__42522)))){
return "tr";
} else {
return "other";
}
