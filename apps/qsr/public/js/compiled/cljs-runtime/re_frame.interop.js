...
return [(function (){var pred__42327 = cljs.core.instance_QMARK_;
var expr__42328 = reactive_val;
if(cljs.core.truth_((pred__42327.cljs$core$IFn$_invoke$arity$2 ? pred__42327.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__42328) : pred__42327.call(null,reagent.ratom.RAtom,expr__42328)))){
return "ra";
} else {
if(cljs.core.truth_((pred__42327.cljs$core$IFn$_invoke$arity$2 ? pred__42327.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__42328) : pred__42327.call(null,reagent.ratom.RCursor,expr__42328)))){
return "rc";
} else {
if(cljs.core.truth_((pred__42327.cljs$core$IFn$_invoke$arity$2 ? pred__42327.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__42328) : pred__42327.call(null,reagent.ratom.Reaction,expr__42328)))){
return "rx";
} else {
if(cljs.core.truth_((pred__42327.cljs$core$IFn$_invoke$arity$2 ? pred__42327.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__42328) : pred__42327.call(null,reagent.ratom.Track,expr__42328)))){
return "tr";
} else {
return "other";
}
