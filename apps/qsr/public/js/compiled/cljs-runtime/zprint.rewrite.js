...
var G__40722 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__40722;
continue;
} else {
var G__40723 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__40723;
continue;
}
} else {
var G__40724 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__40724;
continue;
}
}
...
var G__40699 = zloc;
var G__40700 = (function (){var G__40701 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__40704 = zloc;
var G__40704__$1 = (((G__40704 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__40704) : rewrite_clj.zip.node.call(null,G__40704)));
if((G__40704__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__40704__$1) : zprint.zutil.edn_STAR_.call(null,G__40704__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__40701) : rewrite_clj.zip.root.call(null,G__40701));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__40699,G__40700) : rewrite_clj.zip.replace.call(null,G__40699,G__40700));
});
/**
...
var G__40737 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__40737;
continue;
}
break;
...
var G__40739 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__40740 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__40739;
out = G__40740;
continue;
} else {
...
var G__40755 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__40756 = cljs.core.next(new_loc);
var G__40757 = replaced_loc;
nloc = G__40755;
new_loc = G__40756;
last_loc = G__40757;
continue;
...
return zprint.rewrite.sort_val((function (){var G__40715 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__40715) : rewrite_clj.zip.down.call(null,G__40715));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__40718_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__40718_SHARP_) : rewrite_clj.zip.tag.call(null,p1__40718_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__40718_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__40718_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
