...
var G__40534 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__40534;
continue;
} else {
var G__40535 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__40535;
continue;
}
} else {
var G__40538 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__40538;
continue;
}
}
...
var G__40522 = zloc;
var G__40523 = (function (){var G__40524 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__40525 = zloc;
var G__40525__$1 = (((G__40525 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__40525) : rewrite_clj.zip.node.call(null,G__40525)));
if((G__40525__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__40525__$1) : zprint.zutil.edn_STAR_.call(null,G__40525__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__40524) : rewrite_clj.zip.root.call(null,G__40524));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__40522,G__40523) : rewrite_clj.zip.replace.call(null,G__40522,G__40523));
});
/**
...
var G__40543 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__40543;
continue;
}
break;
...
var G__40569 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__40570 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__40569;
out = G__40570;
continue;
} else {
...
var G__40571 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__40572 = cljs.core.next(new_loc);
var G__40573 = replaced_loc;
nloc = G__40571;
new_loc = G__40572;
last_loc = G__40573;
continue;
...
return zprint.rewrite.sort_val((function (){var G__40528 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__40528) : rewrite_clj.zip.down.call(null,G__40528));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__40531_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__40531_SHARP_) : rewrite_clj.zip.tag.call(null,p1__40531_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__40531_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__40531_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
