...
var G__40516 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__40516__$1 = (((G__40516 == null))?null:cljs.core.iterate(((function (G__40516,n0,temp__5733__auto__){
return (function (loc){
...
});})(G__40516,n0,temp__5733__auto__))
,G__40516));
var G__40516__$2 = (((G__40516__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__40516__$1));
var G__40516__$3 = (((G__40516__$2 == null))?null:cljs.core.last(G__40516__$2));
if((G__40516__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__40516__$3);
}
} else {
return zloc;
}
...
var G__40531 = rewrite_clj.zip.move.right(v);
var G__40532 = rewrite_clj.zip.move.up(v);
loc = G__40531;
parent = G__40532;
continue;
} else {
var G__40533 = rewrite_clj.zip.move.right(v0);
var G__40534 = parent;
loc = G__40533;
parent = G__40534;
continue;
...
var G__40535 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__40536 = rewrite_clj.zip.move.up(v);
loc = G__40535;
parent = G__40536;
continue;
} else {
var G__40537 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__40538 = parent;
loc = G__40537;
parent = G__40538;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__40529 = zloc;
var G__40529__$1 = (((G__40529 == null))?null:rewrite_clj.zip.move.down(G__40529));
var G__40529__$2 = (((G__40529__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__40529__$1,k));
if((G__40529__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__40529__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__40530 = rewrite_clj.zip.move.down(zloc);
var G__40530__$1 = (((G__40530 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__40530));
if((G__40530__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__40530__$1);
}
})(),k);
}
});
