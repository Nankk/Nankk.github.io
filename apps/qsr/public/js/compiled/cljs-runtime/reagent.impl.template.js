...
var G__42351 = o;
(G__42351[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__42376__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__42376 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__42377__i = 0, G__42377__a = new Array(arguments.length -  0);
while (G__42377__i < G__42377__a.length) {G__42377__a[G__42377__i] = arguments[G__42377__i + 0]; ++G__42377__i;}
  args = new cljs.core.IndexedSeq(G__42377__a,0,null);
} 
return G__42376__delegate.call(this,args);};
G__42376.cljs$lang$maxFixedArity = 0;
G__42376.cljs$lang$applyTo = (function (arglist__42378){
var args = cljs.core.seq(arglist__42378);
return G__42376__delegate(args);
});
G__42376.cljs$core$IFn$_invoke$arity$variadic = G__42376__delegate;
return G__42376;
})()
;
} else {
...
var G__42358 = jsprops;
(G__42358["defaultValue"] = value);

(G__42358["onChange"] = ((function (G__42358,v,value,on_change){
return (function (p1__42357_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__42357_SHARP_);
});})(G__42358,v,value,on_change))
);
...
var vec__42360 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42360,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42360,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42360,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___42386 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___42386 == null)){
} else {
var key_42387 = temp__5739__auto___42386;
(jsprops["key"] = key_42387);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__42364 = reagent.impl.template.__GT_NativeWrapper();
(G__42364["name"] = c);
...
var G__42365 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__42365) : reagent.impl.template.as_element.call(null,G__42365));
} else {
...
var len__4730__auto___42393 = arguments.length;
var i__4731__auto___42394 = (0);
while(true){
if((i__4731__auto___42394 < len__4730__auto___42393)){
args__4736__auto__.push((arguments[i__4731__auto___42394]));

var G__42395 = (i__4731__auto___42394 + (1));
i__4731__auto___42394 = G__42395;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq42368){
var G__42369 = cljs.core.first(seq42368);
var seq42368__$1 = cljs.core.next(seq42368);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42369,seq42368__$1);
});
...
break;
default:
var G__42397 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__42397;
continue;
...
var n__4607__auto___42399 = a.length;
var i_42400 = (0);
while(true){
if((i_42400 < n__4607__auto___42399)){
(a[i_42400] = reagent.impl.template.as_element((a[i_42400])));

var G__42401 = (i_42400 + (1));
i_42400 = G__42401;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___42402 = a.length;
var i_42403 = (0);
while(true){
if((i_42403 < n__4607__auto___42402)){
var val_42404 = (a[i_42403]);
if(((cljs.core.vector_QMARK_(val_42404)) && ((reagent.impl.template.key_from_vec(val_42404) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_42403] = reagent.impl.template.as_element(val_42404));

var G__42405 = (i_42403 + (1));
i_42403 = G__42405;
continue;
} else {
}
...
var ctx = ({});
var vec__42372 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42372,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42372,(1),null);
...
var G__42375 = (cljs.core.count(argv) - first_child);
switch (G__42375) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__42375){
